# SalesPulse — Executive Revenue Analytics & Intelligence Platform

SalesPulse — Executive Revenue Analytics & Intelligence Platform is a production-grade enterprise application designed with domain-driven architecture, automated quality validation, and high-performance microservices.
...
```bash
git clone gandhikomarala/sales-dashboard.git
cd sales_repo
python -m venv venv
# Windows:
...
```bash
docker build -t sales_repo:latest .
```
